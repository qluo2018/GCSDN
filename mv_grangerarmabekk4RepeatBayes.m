function output = mv_grangerarmabekk4RepeatBayes(input_data, ar_order, bekk_order, indexX, indexY, fd, priorsX, sigX, priorsY, sigY, priors, sigXY)
...
armabekkX = arma_bekk_mvgarch4RepeatBayes(data(:,indexX), ar_order, bekk_order, Nr, Nl, priorsX, sigX);
armabekkY = arma_bekk_mvgarch4RepeatBayes(data(:,indexY), ar_order, bekk_order, Nr, Nl, priorsY, sigY);
armabekkXY = arma_bekk_mvgarchXY4RepeatBayes(data, ar_order, bekk_order, indexX, indexY, Nr, Nl, priors, sigXY);

%% calculating the statistics
[FX2Y,FY2X, p_x2y, p_y2x] = arma_garch_grangercausality(armabekkXY, armabekkX, armabekkY, ar_order, bekk_order, k, kx, ky);
...
output.granger =  [FX2Y, FY2X, p_x2y, p_y2x];
