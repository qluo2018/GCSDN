function output  = arma_bekk_mvgarchXY4RepeatBayes(data, ar_order,bekk_order, indexX, indexY, Nr, Nl, priors, sig, ARMABEKKoptions)
%% QMLE 
...
ObjectFunction = @(parameters)arma_bekk_mvgarch_likelihoodXY4RepeatBayes(parameters, data, ar_order, bekk_order, kx, ky, Nr, Nl, priors, sig);
...
%%
[loglikelihood,likelihoods,Ht, errors] = arma_bekk_mvgarch_likelihoodXY4RepeatBayes(parameters,data,ar_order,bekk_order, kx, ky, Nr, Nl, priors, sig);

outputLLF = arma_bekk_mvgarch_likelihoodXY4Repeat4XBayes(parameters, data, ar_order,bekk_order, kx, ky, Nr, Nl, priors, sig, indexX, indexY);
...
output.Bayes_x = -outputLLF.Bayes_x;
output.Bayes_y = -outputLLF.Bayes_y;
output.Ht = Ht;
